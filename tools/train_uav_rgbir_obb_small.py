...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--project", default=str(REPO_ROOT / "runs" / "stage4_small"), type=str, help="Output project directory."
    )
    ...
    parser.add_argument(
        "--close-mosaic", default=0, type=int, help="Disable mosaic from the beginning for smoke tests."
    )
    ...
    parser.add_argument(
        ...
        default=0.005,
        type=float,
        help="Normalized OBB area threshold used consistently across Stage 4.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--small-object-sampling-max-weight", default=3.0, type=float, help="Maximum image sampling weight."
    )
    parser.add_argument(
        "--small-object-loss-gain",
        default=0.25,
        type=float,
        help="Conservative gain for Stage 4 small-object loss weighting.",
    )
    parser.add_argument(
